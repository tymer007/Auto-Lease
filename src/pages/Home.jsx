...
function Home() {
  ...
  const [isVerified, setIsVerified] = useState(null); // State for verification status
    ...
    const fetchCars = async () => {
      try {
        const response = await axios.get(
          "https://auto-lease-backend.onrender.com/api/v1/cars/"
        );
  ...
  return (
    <div>
      ...
      {/* Conditionally render VerificationPrompt */}
      <div className="p-4">
        <div className="text-center my-20">
          <h1 className="text-4xl font-bold text-autoPurple">
            Seamless Car Rental Experience In Jos
          </h1>
          <p className="text-autoPurple">
            Discover a wide range of vehicles and flexible rental options.
          </p>
        ...
        {!searchActive && (
          <div className="text-center my-24">
            ...
            <p>
              Our car rental service in Jos offers a wide range of vehicles,
              flexible rental options, and comprehensive insurance coverage.
              Book online today for a worry-free driving experience.
            </p>
            <div className="flex justify-around my-4 sm:flex-row flex-col">
              <div>
                <h3 className="font-bold">Wide Range of Vehicles</h3>
                <p className="mt-2">
                  Choose from our wide selection of vehicles, ranging from
                  compact cars to spacious SUVs.
                </p>
              </div>
              <div>
                <h3 className="font-bold">Flexible Rental Options</h3>
                <p className="mt-2">
                  Rent by the hour, day, week, or month - whatever suits your
                  needs best.
                </p>
              </div>
              <div>
                ...
                <p className="mt-2">
                  Drive with peace of mind, knowing that you have comprehensive
                  coverage.
                </p>
              </div>
            </div>
            <div className="flex gap-4 justify-center">
              <button className="border-autoPurple border-2 p-1 font-semibold text-autoPurple">
                Learn More
              </button>
        ...
        {cars.length > visibleCars && (
          <div className="text-end my-4 mx-8">
            <button
              ...
              className="bg-autoPurple text-white rounded-xl p-3 px-8"
            >
              See More
            </button>
          </div>
        ...
        <section className="text-start mt-12">
          <div className="relative bg-autoPurple text-white py-8 px-6 rounded-2xl mx-4 md:mx-8 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="mb-4">
                Register your dealership and put up your vehicle for rental
              </p>
              <Link
                to="/dealership"
                className="bg-white text-autoPurple font-semibold py-2 px-4 rounded-lg inline-block"
              >
                Register
              </Link>
            </div>
